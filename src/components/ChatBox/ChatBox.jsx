...
export const ChatBox = ({chat, currentUser, setSendMessage, receivedMessage, exit, setModal, setUser}) => {
  ...
  const handleSend = async(e) => {
    ...
    const receivedId = chat?.members?.find(id => id!==currentUser._id)
          ...
          <>
            ...
            <div className="chat-header">
              <div onClick={openModal} className="user-info">
                <div>
                  <img src={userData?.profileImage ? userData.profileImage : profileImg} alt="profile" className="user-image"/>
                </div>
                <div className="name">
